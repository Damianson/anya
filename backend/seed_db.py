...
def populate_seed_data(reset=False):
    """
    Populates benchmark crisis scenarios into the database.
    Expects to be called within an active Flask application context.
    """
    if reset:
